...
const BookingPage = () => {
    ...
    const getDoctorById = async () => {
        try {
            const res = await axios.post(`${process.env.API_KEY}/doctor/getDoctorById`,
                {
    ...
    const handleAvailability = async () => {
        try {
            ...
            const res = await axios.post(`${process.env.API_KEY}/user/booking-availability`, {
                doctorId: params.doctorId,
                date: formattedDate,
                time: formattedTime,
            }, {
    ...
    const handleBooking = async () => {
        try {
            ...
            const res = await axios.post(
                `${process.env.API_KEY}/user/book-appointment`,
                {
                    doctorId: params.doctorId,
                    userId: user._id,
                    doctorInfo: doctors,
