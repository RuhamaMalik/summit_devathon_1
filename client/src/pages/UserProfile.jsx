    ...
    return (
        <Layout>
            ...
            <div className="text-center">
                ...
                <h3 >{user?.email}</h3>
                {user?.isDoctor ? (<h5 className="text-success"> Doctor Profile</h5>) : user?.isAdmin ? (<h5 className="text-success"> Admin Profile</h5>) : (<h5 className="text-success"> User Profile</h5>)}
            </div>
        </Layout>
    )
}
